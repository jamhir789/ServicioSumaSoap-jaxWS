 ...
 * 
 */
@WebServiceClient(name = "ServicioSumarImplService", targetNamespace = "http://beans/", wsdlLocation = "http://localhost:9090/ServicioSumarImplService/ServicioSumarImpl?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9090/ServicioSumarImplService/ServicioSumarImpl?wsdl");
